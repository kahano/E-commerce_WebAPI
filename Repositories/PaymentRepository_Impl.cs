...
namespace E_commercial_Web_RESTAPI.Repositories
{
...

    {
        ...
        public async Task<ApiResponse> CheckOutPayment(long customerId, long CartId, Payment payment)
        {

            var isCustomerAvailable = await _context.orders.FirstOrDefaultAsync(s => s.Id == customerId);
            ...
            var payment_process = await _paymentService.ChargeCardsync(CartId,payment);
            ...
            await _unitOfWork._cart_repository.DeleteBasketItemsAsync(CartId, customerId);
